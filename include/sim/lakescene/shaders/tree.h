...
namespace sim
{
	namespace lake
	{
		...
		public:
			...
			// Utility, for parsing from GenericMesh into TreeVertices
			static std::vector<Vertex> processGenericVertices(const std::vector<view::GenericVertex>& genericVertices);
